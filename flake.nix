      ...
      in
      {
        devShells.default = pkgs.mkShell {
          buildInputs = with pkgs; [
            ...
            # mkdocs and pandoc left with Docs.Html and Docs.Man - the
            # hand-written tree they rendered is not what is published,
            # and a tool the shell provides for a target that no longer
            # exists is a declaration the doctor keeps requiring.
            hugo
