---
title: "gapictl lifecycle reload"
---

## gapictl lifecycle reload

Send reload command to one or more agents

```
gapictl lifecycle reload AGENT... [flags]
```
...
* [gapictl lifecycle](./gapictl_lifecycle/)	 - Control agent lifecycle
