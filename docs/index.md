...
- [**lexicon.md**](./lexicon.md)  
  Terminology and internal language used across the stack.

- [**pandoc_example.md**](./pandoc_example.md)  
  Pandoc markdown example for man page generation.
...
*(Coming soon)*  
Design specs, component outlines, usage scenarios, and event architecture will be added as they solidify.

---

This index will grow with the system. If you're reading it, you're already inside.
