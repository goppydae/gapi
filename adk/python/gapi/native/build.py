# python build stubs for package adk
...
mod.add_function('adk_ChannelManager_CTor', retval('int64_t'), [])
add_checked_function(mod, 'adk_ChannelManager_Send', None, [param('int64_t', '_handle'), param('char*', 'msg'), param('bool', 'goRun')])
