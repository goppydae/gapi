...
type Event struct {
	...
	Type    string     `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`       // e.g., "lifecycle", "eventbus", "status"
	Source  string     `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"`   // e.g., "goblin.daemon"
	Payload *anypb.Any `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"` // Event-specific payload (see below)
}
...
var file_proto_event_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x63, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x12,
